...
const desktopRouteGroups = {
  ...
  reference: [
    {
      route: "/reference/exam-guide",
      markerText: "令和8年度の大きな変更",
      selector: "article",
    },
    {
      route: "/reference/second-stage-question-index",
      markerText: "事例Ⅰ 設問索引",
      selector: "article",
    },
    {
      route: "/reference/past-question-theme-index",
      markerText: "問題文のテーマに近い科目",
      selector: "article",
    },
    {
      route: "/reference/important-terms-glossary",
      markerText: "重要用語集",
      selector: "article",
    },
    {
      route: "/reference/important-formulas",
      markerText: "重要公式・計算式一覧",
      selector: "table",
    },
    {
      route: "/reference/yearly-question-trends",
      markerText: "年度差",
      selector: "article",
    },
    {
      route: "/reference/study-time-model",
      markerText: "学習時間モデル",
      selector: "table",
    },
  ],
  financeAndAccounting: [
    ...
    {
      route: "/finance-and-accounting/bookkeeping-basics-adjusting-entries",
      markerText: "決算整理仕訳",
      selector: "article",
    },
    {
      route: "/finance-and-accounting/bookkeeping-basics-ledgers-and-vouchers",
      markerText: "帳簿組織と伝票",
      selector: "article",
    },
    {
    ...
    {
      route: "/finance-and-accounting/corporate-accounting-assets-accounting",
      markerText: "資産会計",
      selector: "article",
    },
    {
  ...
  economicsAndEconomicPolicy: [
    {
      route: "/economics-and-economic-policy",
      markerText: "章マップ",
      selector: "h2",
    },
    {
  ...
  businessManagementTheory: [
    {
      route: "/business-management-theory",
    ...
    {
      route: "/business-management-theory/knowledge-motivation-theories",
      markerText: "モチベーション理論",
      selector: "article",
    },
    {
      route: "/business-management-theory/knowledge-leadership-theories",
      markerText: "リーダーシップ論",
      selector: "article",
    },
    {
      route: "/business-management-theory/knowledge-human-resource-management",
      markerText: "人的資源管理",
      selector: "article",
    },
    {
    ...
    {
      route: "/business-management-theory/knowledge-stp-and-4p",
      markerText: "STPと4P",
      selector: "article",
    },
    {
    ...
    {
      route: "/business-management-theory/knowledge-product-and-price-strategy",
    ...
    {
      route: "/business-management-theory/knowledge-service-marketing-and-crm",
  ...
  businessLaw: [
    ...
    {
      route: "/business-law/knowledge-company-types-and-incorporation",
      markerText: "会社類型と設立手続",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-shares-and-shareholders",
      markerText: "株式と株主",
      selector: "article",
    },
    {
    ...
    {
      route: "/business-law/knowledge-insolvency-and-corporate-rehabilitation",
      markerText: "倒産法制",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-ip-framework-and-terms",
      markerText: "知的財産権の体系と存続期間",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-patent-law",
      markerText: "特許法",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-utility-model-law",
      markerText: "実用新案法",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-design-law",
      markerText: "意匠法",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-trademark-law",
      markerText: "商標法",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-copyright-law",
      markerText: "著作権法",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-unfair-competition-prevention-law",
      markerText: "不正競争防止法",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-ip-strategy-and-international-protection",
      markerText: "知的財産権の活用と国際的保護",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-contracts-obligations-and-security",
      markerText: "契約・債権・物権・担保",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-prescription-and-guarantee",
      markerText: "時効と保証",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-inheritance",
      markerText: "相続",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-antimonopoly-and-trade-regulation",
      markerText: "独占禁止法と取引適正化",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-consumer-protection-laws",
      markerText: "消費者保護関連法",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-personal-information-protection",
      markerText: "個人情報保護法",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-labor-laws-overview",
      markerText: "労働関連法規の概要",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-capital-market-laws",
      markerText: "資本市場関連法規",
      selector: "article",
    },
    {
      route: "/business-law/knowledge-english-contract-terms",
  ...
  managementInformationSystems: [
    ...
    {
      route: "/management-information-systems/knowledge-computer-basics",
      markerText: "コンピュータの基礎",
      selector: "article",
    },
    {
      route: "/management-information-systems/knowledge-database-and-sql",
      markerText: "データベースとSQL",
      selector: "article",
    },
    {
      route: "/management-information-systems/knowledge-network-basics",
      markerText: "通信ネットワーク",
      selector: "article",
    },
    {
      route: "/management-information-systems/knowledge-web-and-cloud",
  ...
  operationsManagement: [
    ...
    {
      route: "/operations-management/knowledge-factory-layout-and-flow-design",
    ...
    {
      route: "/operations-management/knowledge-quality-management",
      markerText: "品質管理",
      selector: "article",
    },
    {
      route: "/operations-management/knowledge-ie-and-ve",
      markerText: "IEとVE",
      selector: "article",
    },
    {
      route: "/operations-management/knowledge-jit-and-kanban",
      markerText: "JITとかんばん方式",
      selector: "article",
    },
    {
      route: "/operations-management/knowledge-scheduling-and-line-balancing",
    ...
    {
      route: "/operations-management/knowledge-store-location-and-trading-area",
      markerText: "店舗立地と商圏分析",
      selector: "article",
    },
    {
      route: "/operations-management/knowledge-store-layout-and-merchandising",
  ...
  smeManagementAndPolicy: [
    {
      route: "/sme-management-and-policy",
      markerText: "重点更新ページ",
      selector: "h2",
    },
    {
    ...
    {
      route: "/sme-management-and-policy/policy-overseas-expansion-support",
  ...
  secondStage: [
    {
      route: "/second-stage/reading-case-materials",
      markerText: "読み方の型",
      selector: "h2",
    },
    {
      route: "/second-stage/interpreting-questions-and-structuring-answers",
      markerText: "設問解釈の型",
      selector: "h2",
    },
    {
      route: "/second-stage/logical-writing-techniques",
      markerText: "書き方の型",
      selector: "h2",
    },
    {
      route: "/second-stage/case-1-question-patterns",
      markerText: "設問型の全体像",
      selector: "table",
    },
    {
      route: "/second-stage/case-1-answer-frameworks",
      markerText: "レイヤー別の答案骨子",
      selector: "table",
    },
    {
      route: "/second-stage/case-2-question-patterns",
      markerText: "設問型の全体像",
      selector: "table",
    },
    {
      route: "/second-stage/case-2-answer-frameworks",
      markerText: "設問型別の答案骨子",
      selector: "table",
    },
    {
      route: "/second-stage/case-3-question-patterns",
      markerText: "設問型の全体像",
      selector: "table",
    },
    {
      route: "/second-stage/case-3-answer-frameworks",
      markerText: "設問型別の答案骨子",
      selector: "table",
    },
    {
      route: "/second-stage/case-4-question-patterns",
      markerText: "設問型の全体像",
      selector: "table",
    },
    {
      route: "/second-stage/case-4-answer-frameworks",
      markerText: "設問型別の答案骨子",
      selector: "table",
    },
    {
      route: "/second-stage/case-4-management-analysis",
      markerText: "指標選定の型",
      selector: "table",
    },
    {
      route: "/second-stage/case-4-cvp-and-profit-planning",
      markerText: "CVP 型の処理順",
      selector: "table",
    },
    {
      route: "/second-stage/case-4-cash-flow-and-working-capital",
      markerText: "CF 型の処理順",
      selector: "table",
    },
    {
      route: "/second-stage/case-4-npv-and-investment-decision",
...
const uiScenarioRoutes = {
  mobileHubs: ["/finance-and-accounting", "/second-stage", "/reference"],
  darkModeReadingNode: "/second-stage/reading-case-materials",
  focusVisible: "/",
  aiQuestionPanel: "/reference/important-terms-glossary",
  feedbackPage: "/finance-and-accounting",
  bannerAndMath: {
